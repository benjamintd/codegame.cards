export default {
  ...
  "neutral-reaction-4": "Das war ein:e unbeteiligte:r Zuschauer:in.",
  ...
  "black-reaction-4": "Oh nein, du hast auf eine:n Attentäter:in geklickt ☠️",
  ...
  "rules-classic-grid": `25 zufällige Wortkarten werden in einem 5-mal-5-Raster ausgelegt. Ein Teil dieser Wörter steht für <1>rote</1> Agent:innen, ein anderer Teil für <3>blaue</3> Agent:innen, eines für eine:n <5>Attentäter:in</5>, und die anderen repräsentieren <7>unbeteiligte Zuschauer:innen</span>. Die Geheimdienstchef:innen der Teams kennen die Farben der einzelnen Wörter und geben ihrem Team abwechselnd Hinweise, damit sie die Wörter ihrer Farbe erraten.`,
  "rules-classic-hints": `Jeder Hinweis darf nur aus einem einzigen Wort und einer Anzahl von Karten bestehen, auf die er sich bezieht. Der/die Geheimdienstchef:in gibt einen Hinweis, der sich auf möglichst viele der Wörter auf den Karten seiner/ihrer eigenen Agent:innen bezieht, aber nicht auf andere - er oder sie könnte sein Team versehentlich dazu bringen, eine Karte zu wählen, die eine:n unbeteiligte:n Zuschauer:in, eine:n gegnerische:n Agent:in oder den/die Attentäter:in darstellt.`,
  ...
  "rules-classic-game-end": `Das Spiel endet, wenn alle Agent:innen einer Mannschaft identifiziert sind (🏅), oder wenn eine Mannschaft den/die <1>Attentäter:in</1> identifiziert hat (☠️).`,
  ...
  "rules-duet-hints": `Die Spieler:innen geben abwechselnd Hinweise, damit der/die andere Spieler:in seine/ihre grüne Karte errät. Jeder Hinweis darf nur aus einem einzigen Wort und einer Anzahl von Karten bestehen, auf die er sich bezieht. Der/die Geheimdienstchef:in gibt einen Hinweis, der sich auf möglichst viele der Wörter auf den Karten seiner/ihrer eigenen Agent:innen bezieht, aber nicht auf andere - sie könnten den/die andere:n Spieler:in versehentlich dazu verleiten, eine Karte zu wählen, die eine:n unschuldige:n Zuschauer:in oder eine:n Attentäter:in darstellt`,
  "rules-duet-game-end": `Das Spiel endet, wenn alle 15 grünen Agent:innen identifiziert sind (🏅), oder wenn ein:e Spieler:in eine:n <1>Attentäter:in</1> identifiziert hat (☠️). Das Spiel ist zeitbegrenzt. Beide Spieler:innen haben insgesamt 9 Runden Zeit, um alle Wörter zu finden. Ein Klick auf eine:n <3>unschuldige:n Zuschauer:in</span> verbraucht einen zusätzlichen Zug.`,
